...
using MoviesMobileApp.Models.Json;

[assembly: Xamarin.Forms.Dependency (typeof (MoviesMobileApp.Services.RemoteService))]
namespace MoviesMobileApp.Services
{
    class RemoteService : IRemoteService<IMovieItem>
    {
        ...
        /// <summary>
        /// Download movies from moviedb api
        /// </summary>
        /// <param name="page">page number of items</param>
        /// <returns>items on pages</returns>
